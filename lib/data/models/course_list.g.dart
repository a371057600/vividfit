...
_CourseList _$CourseListFromJson(Map<String, dynamic> json) => _CourseList(
...
Map<String, dynamic> _$CourseListToJson(_CourseList instance) =>
    <String, dynamic>{'code': instance.code, 'data': instance.data};

_CourseListData _$CourseListDataFromJson(Map<String, dynamic> json) =>
    _CourseListData(
...
Map<String, dynamic> _$CourseListDataToJson(_CourseListData instance) =>
    <String, dynamic>{
