...
abstract class AuthState with _$AuthState {
  const factory AuthState({
    ...
    @Default(false) bool isNewUser, // 登录结果 code=201 时为 true,驱动跳昵称设置页
    String? loginResultCode, // '200'/'201'/'400'/'402'/'403'/'412'/null
    ...
    @Default('') String wechatCode, // 微信 code(预留占位)
    ...
    @Default(0) int languageNum, // 0=简中 1=英 2=繁中(决定登录入口显示)
  }) = _AuthState;
}
