...
@override
int get hashCode => Object.hashAll([runtimeType,deviceType,screenStatus,allowTouch,showPlayButton,isPlaying,isPause,isPauseScreen,isStopScreen,courseTitle,difficulty,level,targetResistanceLevel,sportTime,sportDistance,sportCalories,sportSpeed,sportDeviceSpeed,sportHeartRate,sportCadence,sportStrokeRate,sportStrokeCount,sportInclination,sportResistance,sportSpeedButton,sportInclinationButton,sportResistanceButton,hasInclinationSupport,minSpeed,maxSpeed,minInclination,maxInclination,minResistance,maxResistance,playIndex,currentDuration,playIndexDuration,playTotalDuration,totalPlayProgressDuration,imagePlayIndex,imageFps,rootImagePath,rootBgmPath,rootVoicePath,playProgressPercent,const DeepCollectionEquality().hash(courseActions),const DeepCollectionEquality().hash(currentActionNameList),const DeepCollectionEquality().hash(progressSegments),const DeepCollectionEquality().hash(finishDataIcons),const DeepCollectionEquality().hash(finishDataTitles),const DeepCollectionEquality().hash(finishDataValues),const DeepCollectionEquality().hash(finishDataUnits),const DeepCollectionEquality().hash(ratingTitles),const DeepCollectionEquality().hash(ratingScores),scoreLevel,const DeepCollectionEquality().hash(ratingImageIndices),const DeepCollectionEquality().hash(speedChartData)]);
