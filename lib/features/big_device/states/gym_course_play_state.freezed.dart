...
/// 设备类型
 ...
 int get imageFps;/// 播放进度百分比 (0.0-1.0)，控制底部箭头位置
 ...
 List<double> get speedChartData;
...
as int,playProgressPercent: null == playProgressPercent ? _self.playProgressPercent : playProgressPercent // ignore: cast_nullable_to_non_nullable
...
mixin _$ActionItemState {
 ...
 String get name; String get imageName; int get duration; int get resistance; int get cadence; int get posture; bool get isRestStage; int get imageFps; int get imageLength; int get orderId; int get count; int get distance;
...
@override
int get hashCode => Object.hash(runtimeType,name,imageName,duration,resistance,cadence,posture,isRestStage,imageFps,imageLength,orderId,count,distance);

@override
String toString() {
  return 'ActionItemState(name: $name, imageName: $imageName, duration: $duration, resistance: $resistance, cadence: $cadence, posture: $posture, isRestStage: $isRestStage, imageFps: $imageFps, imageLength: $imageLength, orderId: $orderId, count: $count, distance: $distance)';
}
...
@useResult
$Res call({
 String name, String imageName, int duration, int resistance, int cadence, int posture, bool isRestStage, int imageFps, int imageLength, int orderId, int count, int distance
});
...
/// Create a copy of ActionItemState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? imageName = null,Object? duration = null,Object? resistance = null,Object? cadence = null,Object? posture = null,Object? isRestStage = null,Object? imageFps = null,Object? imageLength = null,Object? orderId = null,Object? count = null,Object? distance = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String imageName,  int duration,  int resistance,  int cadence,  int posture,  bool isRestStage,  int imageFps,  int imageLength,  int orderId,  int count,  int distance)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionItemState() when $default != null:
return $default(_that.name,_that.imageName,_that.duration,_that.resistance,_that.cadence,_that.posture,_that.isRestStage,_that.imageFps,_that.imageLength,_that.orderId,_that.count,_that.distance);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String imageName,  int duration,  int resistance,  int cadence,  int posture,  bool isRestStage,  int imageFps,  int imageLength,  int orderId,  int count,  int distance)  $default,) {final _that = this;
switch (_that) {
case _ActionItemState():
return $default(_that.name,_that.imageName,_that.duration,_that.resistance,_that.cadence,_that.posture,_that.isRestStage,_that.imageFps,_that.imageLength,_that.orderId,_that.count,_that.distance);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String imageName,  int duration,  int resistance,  int cadence,  int posture,  bool isRestStage,  int imageFps,  int imageLength,  int orderId,  int count,  int distance)?  $default,) {final _that = this;
switch (_that) {
case _ActionItemState() when $default != null:
return $default(_that.name,_that.imageName,_that.duration,_that.resistance,_that.cadence,_that.posture,_that.isRestStage,_that.imageFps,_that.imageLength,_that.orderId,_that.count,_that.distance);case _:
  return null;
...
class _ActionItemState implements ActionItemState {
  const _ActionItemState({this.name = 'Warm Up', this.imageName = '', this.duration = 60, this.resistance = 3, this.cadence = 25, this.posture = 0, this.isRestStage = false, this.imageFps = 30, this.imageLength = 300, this.orderId = 0, this.count = 0, this.distance = 0});
...
/// Create a copy of ActionItemState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? imageName = null,Object? duration = null,Object? resistance = null,Object? cadence = null,Object? posture = null,Object? isRestStage = null,Object? imageFps = null,Object? imageLength = null,Object? orderId = null,Object? count = null,Object? distance = null,}) {
