...
/// 是否显示开始按钮（对应旧 hc.showPlayButton）。
 ...
 bool get hasInclinationSupport;/// 设备运行状态检测：进入界面时设备是否正在被动运行
