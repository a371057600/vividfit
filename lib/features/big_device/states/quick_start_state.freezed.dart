...
/// 是否显示开始按钮（对应旧 hc.showPlayButton）。
 ...
 bool get hasInclinationSupport;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool showPlayButton,  bool isPaused,  bool isInQuickPlay,  bool isPlaying,  bool isMusicPlaying,  int realSportTime,  double sportDistance,  double sportEnergy,  double sportSpeed,  double sportCadence,  int sportHeartRate,  double sportStrokeRate,  double sportStrokeCount,  double npcTime,  int maxSpeed,  double sportResistanceButton,  double sportSpeedButton,  double sportInclinationButton,  List<double> buttonResistanceList,  List<double> buttonSpeedList,  List<double> buttonInclinationList,  bool hasInclinationSupport)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _QuickStartState() when $default != null:
return $default(_that.showPlayButton,_that.isPaused,_that.isInQuickPlay,_that.isPlaying,_that.isMusicPlaying,_that.realSportTime,_that.sportDistance,_that.sportEnergy,_that.sportSpeed,_that.sportCadence,_that.sportHeartRate,_that.sportStrokeRate,_that.sportStrokeCount,_that.npcTime,_that.maxSpeed,_that.sportResistanceButton,_that.sportSpeedButton,_that.sportInclinationButton,_that.buttonResistanceList,_that.buttonSpeedList,_that.buttonInclinationList,_that.hasInclinationSupport);case _:
  return orElse();
...
class _QuickStartState implements QuickStartState {
  const _QuickStartState({this.showPlayButton = true, this.isPaused = false, this.isInQuickPlay = false, this.isPlaying = false, this.isMusicPlaying = false, this.realSportTime = 0, this.sportDistance = 0.0, this.sportEnergy = 0.0, this.sportSpeed = 0.0, this.sportCadence = 0.0, this.sportHeartRate = 0, this.sportStrokeRate = 0.0, this.sportStrokeCount = 0.0, this.npcTime = 0.0, this.maxSpeed = 0, this.sportResistanceButton = 0.0, this.sportSpeedButton = 0.0, this.sportInclinationButton = 0.0,  List<double> buttonResistanceList = const <double>[0, 0, 0, 0],  List<double> buttonSpeedList = const <double>[0, 0, 0, 0],  List<double> buttonInclinationList = const <double>[0, 0, 0, 0], this.hasInclinationSupport = false}): _buttonResistanceList = buttonResistanceList,_buttonSpeedList = buttonSpeedList,_buttonInclinationList = buttonInclinationList;
