...
@override
int get hashCode => Object.hashAll([runtimeType,showPlayButton,isPaused,isInQuickPlay,isPlaying,isMusicPlaying,realSportTime,sportDistance,sportEnergy,sportSpeed,sportCadence,sportHeartRate,sportStrokeRate,sportStrokeCount,npcTime,maxSpeed,sportResistanceButton,sportSpeedButton,sportInclinationButton,const DeepCollectionEquality().hash(buttonResistanceList),const DeepCollectionEquality().hash(buttonSpeedList),const DeepCollectionEquality().hash(buttonInclinationList),hasInclinationSupport,isDeviceRunningDetected,const DeepCollectionEquality().hash(achievedTimeLevels),const DeepCollectionEquality().hash(achievedDistanceLevels),const DeepCollectionEquality().hash(achievedEnergyLevels),timeDialogDisplayState,distanceDialogDisplayState,energyDialogDisplayState,currentTimeGoalSec,currentDistanceGoalKm,currentEnergyGoalKcal]);
